  ...
  "lib/makeWorklet.js"(exports2) {
    ...
    function makeWorklet(fun, state) {
      ...
      const statements = [
        ...
        (0, types_1.expressionStatement)((0, types_1.assignmentExpression)("=", (0, types_1.memberExpression)(privateFunctionId, (0, types_1.identifier)("__closure"), false), (0, types_1.objectExpression)(variables.map((variable) => (0, types_1.objectProperty)((0, types_1.identifier)(variable.name), variable, false, false))))),
