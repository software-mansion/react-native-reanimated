...
function buildWorkletString(t, fun, closureVariables, name, inputMap) {
    ...
    if (!BabelTypes.isFunctionDeclaration(expression) &&
        ...
        throw new Error("'expression' is not FunctionDeclaration or FunctionExpression or ObjectMethod\n");
...
function makeWorklet(t, fun, state) {
    ...
    const statements = [
        ...
        BabelTypes.expressionStatement(BabelTypes.assignmentExpression('=', BabelTypes.memberExpression(privateFunctionId, t.identifier('_closure'), false), BabelTypes.objectExpression(variables.map((variable) => BabelTypes.objectProperty(t.identifier(variable.name), variable, false, true))))),
