...
jni::local_ref<JavaWrapperJSConfigManager::jhybriddata>
JavaWrapperJSConfigManager::initHybrid(jni::alias_ref<jhybridobject> jThis) {
...
void JavaWrapperJSConfigManager::registerNatives() {
  registerHybrid({
      ...
      makeNativeMethod(
          "getSharedTransitionConfig",
          JavaWrapperJSConfigManager::getSharedTransitionConfig),
  });
}
