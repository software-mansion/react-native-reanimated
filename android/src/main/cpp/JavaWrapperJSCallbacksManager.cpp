...
jni::local_ref<JavaWrapperJSCallbacksManager::jhybriddata>
JavaWrapperJSCallbacksManager::initHybrid(jni::alias_ref<jhybridobject> jThis) {
...
void JavaWrapperJSCallbacksManager::registerNatives() {
  registerHybrid({
      ...
      makeNativeMethod(
          "executeSharedAnimationProgressCallback",
          JavaWrapperJSCallbacksManager::
              executeSharedAnimationProgressCallback),
  });
}
...
JavaWrapperJSCallbacksManager::executeSharedAnimationProgressCallback(
  ...
  jsi::Value convertedValues =
      JNIHelper::convertJNIMapToJSIObject(runtime, sharedAnimationWorkletData);
  jsi::Value values =
      jsCallbacksManager_->executeSharedAnimationProgressCallback(
