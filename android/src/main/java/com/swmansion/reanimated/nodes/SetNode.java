...
public class SetNode extends Node {
  ...
  public SetNode(int nodeID, ReadableMap config, NodesManager nodesManager) {
    ...
    mWhatNodeID = MapUtils.getInt(config, "what", "'what' argument passed to set node might be of wrong type. NodeID: " + nodeID);
    mValueNodeID = MapUtils.getInt(config, "value", "'value' argument passed to set node might be of wrong type. NodeID: " + nodeID);
  }
