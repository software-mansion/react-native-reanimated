...
/* package */ class SafeAreaUtils {
    ...
    static @Nullable
    com.swmansion.reanimated.safeareacontext.Rect getFrame(ViewGroup rootView, View view) {
        ...
        return new com.swmansion.reanimated.safeareacontext.Rect(offset.left, offset.top, view.getWidth(), view.getHeight());
    }
}