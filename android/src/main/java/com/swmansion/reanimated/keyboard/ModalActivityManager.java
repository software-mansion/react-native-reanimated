...
public class ModalActivityManager {
    ...
    public ModalActivityManager(WeakReference<ReactApplicationContext> reactContext, Keyboard keyboard, NotifyAboutKeyboardChangeFunction notifyAboutKeyboardChange) {
    ...
    * */
    ...
    public Integer createInsetManager() {
        ...
        WindowsInsetsManager newInsetManager = new WindowsInsetsManager(this, mKeyboard, mNotifyAboutKeyboardChange);
