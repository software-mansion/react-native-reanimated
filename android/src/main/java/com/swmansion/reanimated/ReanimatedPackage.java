...
public class ReanimatedPackage
    extends TurboReactPackage implements ReactPackage {
  @Override
  ...
  /**
   * Get the {@link ReactInstanceManager} used by this app. By default, assumes
   * {@link ReactApplicationContext#getApplicationContext()} is an instance of
   * {@link ReactApplication} and calls {@link
   * ReactApplication#getReactNativeHost().getReactInstanceManager()}. Override
   * this method if your application class does not implement {@code
   * ReactApplication} or you simply have a different mechanism for storing a
   * {@code ReactInstanceManager}, e.g. as a static field somewhere.
   */
