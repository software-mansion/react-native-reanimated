...
If you want to play with the API but don't feel like trying it on a real app, you can run the example project. Check the Example/ directory README for installation instructions.
