...
var require_gestureHandlerAutoworkletization = __commonJS({
  'lib/gestureHandlerAutoworkletization.js'(exports2) {
    ...
    exports2.gestureHandlerObjectHooks = exports2.gestureHandlerBuilderMethods =
      void 0;
    exports2.isGestureHandlerEventCallback = isGestureHandlerEventCallback;
    exports2.isGestureObjectEventCallbackMethod =
    ...
    function isGestureObjectEventCallbackMethod(exp) {
      return (
        ...
        exports2.gestureHandlerBuilderMethods.has(exp.property.name) &&
...
var require_types = __commonJS({
  'lib/types.js'(exports2) {
    ...
    exports2.generatedWorkletsDir =
      exports2.workletClassFactorySuffix =
    ...
    function isWorkletizableFunctionNode(node) {
      return (
        (0, types_12.isFunctionDeclaration)(node) ||
        (0, types_12.isFunctionExpression)(node) ||
        (0, types_12.isArrowFunctionExpression)(node) ||
        (0, types_12.isObjectMethod)(node)
      );
    }
...
var require_referencedWorklets = __commonJS({
  'lib/referencedWorklets.js'(exports2) {
    ...
    function findReferencedWorkletFromVariableDeclarator(
      ...
      if (
        acceptWorkletizableFunction &&
        (0, types_2.isWorkletizableFunctionPath)(worklet)
      ) {
        return worklet;
      }
    ...
    function findReferencedWorkletFromAssignmentExpression(
      ...
      const workletDeclaration = workletBinding.constantViolations
        ...
        .find(
          (constantViolation) =>
            ...
            ((acceptWorkletizableFunction &&
              (0, types_2.isWorkletizableFunctionPath)(
                constantViolation.get('right')
              )) ||
              (acceptObject &&
                (0, types_2.isWorkletizableObjectPath)(
                  constantViolation.get('right')
                )))
        );
      ...
      if (
        acceptWorkletizableFunction &&
        (0, types_2.isWorkletizableFunctionPath)(workletDefinition)
      ) {
        return workletDefinition;
      }
      if (
        acceptObject &&
        (0, types_2.isWorkletizableObjectPath)(workletDefinition)
      ) {
        return workletDefinition;
      }
      if (
    ...
    function bindingIsWorklet(binding) {
      return binding.referencePaths.some(
        (refPath) =>
          ...
          (0, types_12.isMemberExpression)(refPath.container) &&
          refPath.container.object === refPath.node &&
          (0, types_12.isIdentifier)(refPath.container.property) &&
...
var require_findWorklet = __commonJS({
  'lib/findWorklet.js'(exports2) {
    ...
    function findWorklet(
      ...
      if (
        acceptWorkletizableFunction &&
        (0, types_12.isWorkletizableFunctionPath)(nodePath)
      ) {
        return nodePath;
      }
      ...
      if (nodePath.isIdentifier() && nodePath.isReferencedIdentifier()) {
        const worklet = (0, referencedWorklets_1.findReferencedWorklet)(
          nodePath,
          acceptWorkletizableFunction,
          acceptObject,
          state
...
var require_utils = __commonJS({
  'lib/utils.js'(exports2) {
    ...
    function needsDeclaration(nodePath) {
      return (
        (0, types_12.isScopable)(nodePath.parent) ||
        (0, types_12.isExportNamedDeclaration)(nodePath.parent)
      );
    }
  },
});
...
var require_globals = __commonJS({
  'lib/globals.js'(exports2) {
    ...
    exports2.globals =
      ...
      exports2.internalBindingsToCaptureFromGlobalScope =
      ...
      funPath.traverse(
        {
          ...
          ReferencedIdentifier(idPath) {
            ...
            if (
              globals_12.outsideBindingsToCaptureFromGlobalScope.has(name) ||
              (!state.opts.bundleMode &&
                globals_12.internalBindingsToCaptureFromGlobalScope.has(name))
            ) {
              return;
            }
            ...
            if (state.opts.bundleMode && isImport(binding)) {
              ...
              if (
                isWorkletizableModule(source, state.opts.workletizableModules)
              ) {
                capturedNames.add(name);
  ...
  'lib/generate.js'(exports2) {
    ...
    function generateWorkletFile(
      ...
      const libraryImports = Array.from(libraryBindingsToImport)
        ...
        .map((binding) =>
          (0, types_12.importDeclaration)(
            [(0, types_12.cloneNode)(binding.path.node, true)],
            (0, types_12.stringLiteral)(
              binding.path.parentPath.node.source.value
            )
          )
        );
      const filesDirPath = (0, path_1.resolve)(
        (0, path_1.dirname)(
          require.resolve('react-native-worklets/package.json')
        ),
        types_2.generatedWorkletsDir
      );
      const relativeImports = Array.from(relativeBindingsToImport)
        ...
        .map((binding) => {
          const resolved = (0, path_1.resolve)(
            (0, path_1.dirname)(state.file.opts.filename),
            binding.path.parentPath.node.source.value
          );
          const importPath = (0, path_1.relative)(filesDirPath, resolved);
          return (0, types_12.importDeclaration)(
            [(0, types_12.cloneNode)(binding.path.node, true)],
            (0, types_12.stringLiteral)(importPath)
          );
        });
      ...
      const transformedProg =
        (_a = (0, core_1.transformFromAstSync)(newProg, void 0, {
      ...
      (0, assert_1.default)(
        transformedProg,
        '[Worklets] `transformedProg` is undefined.'
      );
      if (!(0, fs_1.existsSync)(filesDirPath)) {
        (0, fs_1.mkdirSync)(filesDirPath, {});
      }
      const dedicatedFilePath = (0, path_1.resolve)(
        filesDirPath,
        `${workletHash}.js`
      );
...
var require_transform = __commonJS({
  'lib/transform.js'(exports2) {
    ...
    function workletTransformSync(code, opts) {
      const { extraPlugins = [], extraPresets = [] } = opts,
        rest = __rest(opts, ['extraPlugins', 'extraPresets']);
    ...
    var defaultPresets = [require.resolve('@babel/preset-typescript')];
    var defaultPlugins = [];
  },
});
  ...
  'lib/workletStringCode.js'(exports2) {
    ...
    function buildWorkletString(
        ...
        (0, core_1.traverse)(fun, {
          NewExpression(path) {
            ...
            const workletClassFactoryName =
              constructorName + types_2.workletClassFactorySuffix;
            closureVariables.push(
              (0, types_12.identifier)(workletClassFactoryName)
            );
      ...
      const workletFunction = (0, types_12.functionExpression)(
        (0, types_12.identifier)(workletName),
        expression.params,
        expression.body,
      ...
      const includeSourceMap = !(
        (0, utils_1.isRelease)() || state.opts.disableSourceMaps
      );
      if (includeSourceMap) {
      ...
      const transformed = (0, transform_1.workletTransformSync)(code, {
        ...
        extraPlugins: [
          ...
          ...((_a = state.opts.extraPlugins) !== null && _a !== void 0
            ? _a
            : []),
        ],
  ...
  'lib/workletFactory.js'(exports2) {
    ...
    function makeWorkletFactory(fun, state) {
      ...
      codeObject.code =
        ...
        codeObject.code +
        '\n)';
      const transformed = (0, transform_1.workletTransformSync)(
        codeObject.code,
        {
          extraPlugins: [
            ...extraPlugins,
      ...
      const {
        ...
        libraryBindingsToImport,
        relativeBindingsToImport,
      } = (0, closure_1.getClosure)(fun, state);
      ...
      if (state.opts.bundleMode) {
        mutatedClosureVariables = closureVariables.map((variable) =>
          (0, types_12.cloneNode)(variable, true)
        );
      } else {
      ...
      const pathForStringDefinitions = fun.parentPath.isProgram()
        ...
        : fun.findParent((path) => {
            var _a2, _b;
            return (_b =
              (_a2 = path.parentPath) === null || _a2 === void 0
                ? void 0
                : _a2.isProgram()) !== null && _b !== void 0
              ? _b
              : false;
          });
      (0, assert_1.strict)(
        ...
        (0, types_12.expressionStatement)(
          (0, types_12.assignmentExpression)(
            ...
            (0, types_12.objectExpression)(
              closureVariables.map((variable) =>
                !state.opts.bundleMode &&
                variable.name.endsWith(types_2.workletClassFactorySuffix)
                  ? (0, types_12.objectProperty)(
                      (0, types_12.identifier)(variable.name),
                      (0, types_12.memberExpression)(
                        (0, types_12.identifier)(
                          variable.name.slice(
                            ...
                            variable.name.length -
                              types_2.workletClassFactorySuffix.length
                          )
                        ),
                        (0, types_12.identifier)(variable.name)
                      )
        ...
        statements.push(
          (0, types_12.expressionStatement)(
            (0, types_12.assignmentExpression)(
              ...
              (0, types_12.memberExpression)(
                (0, types_12.identifier)(reactName),
                (0, types_12.identifier)('__pluginVersion')
              ),
              (0, types_12.stringLiteral)(
      ...
      const factoryParams = closureVariables.map((variableId) => {
        ...
        if (
          !state.opts.bundleMode &&
          clonedId.name.endsWith(types_2.workletClassFactorySuffix)
        ) {
          clonedId.name = clonedId.name.slice(
            0,
            clonedId.name.length - types_2.workletClassFactorySuffix.length
          );
        }
        return clonedId;
      });
      ...
      const factoryParamObjectPattern = (0, types_12.objectPattern)(
        factoryParams.map((param) =>
          (0, types_12.objectProperty)(
            (0, types_12.cloneNode)(param, true),
            (0, types_12.cloneNode)(param, true),
            false,
            true
          )
      ...
      const factory = (0, types_12.functionExpression)(
        (0, types_12.identifier)(workletName + 'Factory'),
        [factoryParamObjectPattern],
        (0, types_12.blockStatement)(statements)
      );
      const factoryCallArgs = factoryParams.map((param) =>
        (0, types_12.cloneNode)(param, true)
      );
      const factoryCallParamPack = (0, types_12.objectExpression)(
      ...
      if (state.opts.bundleMode) {
        (0, generate_1.generateWorkletFile)(
          libraryBindingsToImport,
          relativeBindingsToImport,
          factory,
          workletHash,
    ...
    function makeWorkletName(fun, state) {
      ...
      const workletName = reactName
        ? (0, types_12.toIdentifier)(`${reactName}_${suffix}`)
        : (0, types_12.toIdentifier)(suffix);
...
var require_workletFactoryCall = __commonJS({
  'lib/workletFactoryCall.js'(exports2) {
    ...
    function makeWorkletFactoryCall(path, state) {
      const { factory, factoryCallParamPack, workletHash } = (0,
      workletFactory_1.makeWorkletFactory)(path, state);
      let factoryCall;
      if (state.opts.bundleMode) {
        factoryCall = (0, types_12.callExpression)(
          (0, types_12.memberExpression)(
            (0, types_12.callExpression)((0, types_12.identifier)('require'), [
              (0, types_12.stringLiteral)(
                `react-native-worklets/${types_2.generatedWorkletsDir}/${workletHash}.js`
              ),
            ]),
        ...
        factoryCall = (0, types_12.callExpression)(factory, [
          factoryCallParamPack,
        ]);
      }
  ...
  'lib/workletSubstitution.js'(exports2) {
    ...
    function substituteWorkletWithWorkletFactoryCall(path, workletFactoryCall) {
      ...
      if (path.isObjectMethod()) {
        ...
        const name =
          'id' in path.node
            ? (_a = path.node.id) === null || _a === void 0
              ? void 0
              : _a.name
            : void 0;
...
var require_objectWorklets = __commonJS({
  'lib/objectWorklets.js'(exports2) {
    ...
    function tryProcessingNode(
      ...
      var _a;
      const maybeWorklet = (0, findWorklet_1.findWorklet)(
        arg,
        state,
        acceptWorkletizableFunction,
        acceptObject
      ...
      if (
        !maybeWorklet ||
        ((_a = maybeWorklet.getFunctionParent()) === null || _a === void 0
          ? void 0
          : _a.node.workletized)
      ) {
        return;
...
var require_autoworkletization = __commonJS({
  'lib/autoworkletization.js'(exports2) {
    ...
    function processCalleesAutoworkletizableCallbacks(path, state) {
      ...
      if (
        reanimatedFunctionHooks.has(name) ||
        reanimatedObjectHooks.has(name)
      ) {
        ...
        !(0, types_12.isV8IntrinsicIdentifier)(callee) &&
        (0,
        gestureHandlerAutoworkletization_1.isGestureObjectEventCallbackMethod)(
          callee
        )
      ) {
    ...
    function processArgs(
      ...
      args.forEach((arg) => {
        (0, objectWorklets_1.tryProcessingNode)(
          arg,
          state,
          acceptWorkletizableFunction,
          acceptObject
...
var require_bundleMode = __commonJS({
  'lib/bundleMode.js'(exports2) {
    ...
    function toggleBundleMode(path, state) {
      ...
      if (
        !state.opts.bundleMode ||
        !((_a = state.filename) === null || _a === void 0
          ? void 0
          : _a.includes('workletRuntimeEntry'))
      ) {
        return;
      }
...
var require_class = __commonJS({
  'lib/class.js'(exports2) {
    ...
    function processClass(classPath, state) {
      ...
      polyfilledClassAst.program.body.push(
        (0, types_12.returnStatement)((0, types_12.identifier)(className))
      );
      const factoryFactory = (0, types_12.functionExpression)(
        null,
        [],
        (0, types_12.blockStatement)([...polyfilledClassAst.program.body])
      );
    ...
    function getPolyfilledAst(classNode, state) {
      ...
      const classWithPolyfills = (0, transform_1.workletTransformSync)(
        classCode,
        {
          extraPlugins: [
    ...
    function replaceClassDeclarationWithFactoryAndCall(statements, className) {
      ...
      const classDeclarationInit =
        classDeclarationToReplace.declarations[0].init;
      const classFactoryDeclaration = (0, types_12.functionDeclaration)(
        (0, types_12.identifier)(classFactoryName),
        [],
    ...
    function getPolyfilledClassDeclarationIndex(statements, className) {
      const index = statements.findIndex(
        (statement) =>
          (0, types_12.isVariableDeclaration)(statement) &&
          statement.declarations.some(
            (declaration) =>
              (0, types_12.isIdentifier)(declaration.id) &&
    ...
    function hasWorkletClassMarker(classBody) {
      return classBody.body.some(
        (statement) =>
          (0, types_12.isClassProperty)(statement) &&
          (0, types_12.isIdentifier)(statement.key) &&
          ...
          enter: (functionPath) => {
            ...
            statements.forEach((statement, index) => {
              ...
              if (
                ...
                !((_a = statement.node.id) === null || _a === void 0
                  ? void 0
                  : _a.name)
              ) {
                return;
              ...
              statement.traverse({
                Identifier(path) {
                  if (
                    isOutsideDependency(path, bindingIdentifiers, statement)
                  ) {
    ...
    function isWorkletizableClass(classPath, state) {
      var _a;
      const className =
        (_a = classPath.node.id) === null || _a === void 0 ? void 0 : _a.name;
  ...
  'lib/contextObject.js'(exports2) {
    ...
    function isContextObject(objectExpression) {
      return objectExpression.properties.some(
        (property) =>
          (0, types_12.isObjectProperty)(property) &&
          (0, types_12.isIdentifier)(property.key) &&
          property.key.name === exports2.contextObjectMarker
      );
    }
    function processWorkletContextObject(objectExpression) {
      const workletObjectFactory = (0, types_12.functionExpression)(
        ...
        (0, types_12.blockStatement)(
          [
            (0, types_12.returnStatement)(
              (0, types_12.cloneNode)(objectExpression)
            ),
          ],
          [(0, types_12.directive)((0, types_12.directiveLiteral)('worklet'))]
        )
      ...
      objectExpression.properties.push(
        (0, types_12.objectProperty)(
          (0, types_12.identifier)(`${exports2.contextObjectMarker}Factory`),
  ...
  'lib/file.js'(exports2) {
    ...
    function processWorkletizableEntity(nodePath, state) {
      ...
      if ((0, types_2.isWorkletizableFunctionPath)(nodePath)) {
        ...
        if (
          (_a = nodePath.node.id) === null || _a === void 0 ? void 0 : _a.name
        ) {
    ...
    function replaceImplicitReturnWithBlock(path) {
      if (!(0, types_12.isBlockStatement)(path.body)) {
        path.body = (0, types_12.blockStatement)([
          (0, types_12.returnStatement)(path.body),
        ]);
      }
    }
    ...
    function appendWorkletContextObjectMarker(objectExpression) {
      if (
        objectExpression.properties.some(
          (value) =>
            (0, types_12.isObjectProperty)(value) &&
            (0, types_12.isIdentifier)(value.key) &&
            value.key.name === contextObject_12.contextObjectMarker
        )
      ) {
        return;
      }
      objectExpression.properties.push(
        (0, types_12.objectProperty)(
          (0, types_12.identifier)(`${contextObject_12.contextObjectMarker}`),
          (0, types_12.booleanLiteral)(true)
        )
      );
    }
    ...
    function appendWorkletClassMarker(classBody) {
      classBody.body.push(
        (0, types_12.classProperty)(
          (0, types_12.identifier)('__workletClass'),
          (0, types_12.booleanLiteral)(true)
        )
      );
    }
    ...
    function isCommonJSExport(statement) {
      return (
        (0, types_12.isExpressionStatement)(statement) &&
        (0, types_12.isAssignmentExpression)(statement.expression) &&
        (0, types_12.isMemberExpression)(statement.expression.left) &&
        (0, types_12.isIdentifier)(statement.expression.left.object) &&
