    ...
    function buildWorkletString(fun, state, closureVariables, workletName, inputMap) {
      ...
      (0, core_1.traverse)(fun, {
        NewExpression(path) {
          ...
          const workletClassFactoryName = constructorName + types_22.workletClassFactorySuffix;
...
var require_workletFactory = __commonJS({
  "lib/workletFactory.js"(exports2) {
    ...
    function makeWorkletFactory(fun, state) {
      ...
      const params = closureVariables.map((variable) => fun.scope.generateUidIdentifier(variable.name));
      ...
      let [funString, sourceMapString] = (0, workletStringCode_1.buildWorkletString)(transformed.ast, state, closureVariables, workletName, transformed.map);
      ...
      const statements = [
        ...
        (0, types_12.expressionStatement)((0, types_12.assignmentExpression)("=", (0, types_12.memberExpression)((0, types_12.identifier)(reactName), (0, types_12.identifier)("__closure"), false), (0, types_12.objectExpression)(closureVariables.map((variable, id) => variable.name.endsWith(types_22.workletClassFactorySuffix) ? (0, types_12.objectProperty)((0, types_12.identifier)(variable.name), (0, types_12.memberExpression)((0, types_12.identifier)(variable.name.slice(0, variable.name.length - types_22.workletClassFactorySuffix.length)), (0, types_12.identifier)(variable.name))) : (0, types_12.objectProperty)((0, types_12.identifier)(variable.name), (0, types_12.identifier)(params[id].name), false, true))))),
      ...
      if (shouldIncludeInitData) {
        statements.push((0, types_12.expressionStatement)((0, types_12.assignmentExpression)("=", (0, types_12.memberExpression)((0, types_12.identifier)(reactName), (0, types_12.identifier)("__initData"), false), (0, types_12.identifier)("_" + initDataId.name))));
      }
      ...
      const factoryParams = [(0, types_12.identifier)("_" + initDataId.name), ...params];
      const workletFactory = (0, types_12.functionDeclaration)((0, types_12.identifier)(workletName + "Factory"), factoryParams, (0, types_12.blockStatement)(statements));
      pathForStringDefinitions.insertBefore(workletFactory);
      pathForStringDefinitions.insertBefore((0, types_12.expressionStatement)((0, types_12.callExpression)((0, types_12.identifier)("__registerWorkletFactory"), [
  ...
  "lib/workletSubstitution.js"(exports2) {
    ...
    function processWorklet(path, state) {
      if (state.opts.processNestedWorklets) {
        path.traverse({
          [types_22.WorkletizableFunction](subPath, passedState) {
  ...
  "lib/autoworkletization.js"(exports2) {
    ...
    function processArgs(args, state, acceptWorkletizableFunction, acceptObject) {
      args.forEach((arg) => {
        ...
        if ((0, types_22.isWorkletizableFunctionPath)(maybeWorklet)) {
          (0, workletSubstitution_12.processWorklet)(maybeWorklet, state);
        } else if ((0, types_22.isWorkletizableObjectPath)(maybeWorklet)) {
    ...
    function findWorklet(arg, acceptWorkletizableFunction, acceptObject) {
      if (acceptWorkletizableFunction && (0, types_22.isWorkletizableFunctionPath)(arg)) {
        return arg;
      }
      if (acceptObject && (0, types_22.isWorkletizableObjectPath)(arg)) {
        return arg;
      }
...
var require_class = __commonJS({
  "lib/class.js"(exports2) {
    ...
    function replaceClassDeclarationWithFactoryAndCall(statements, className) {
      const classFactoryName = className + types_22.workletClassFactorySuffix;
...
var require_file = __commonJS({
  "lib/file.js"(exports2) {
    ...
    function processWorkletizableEntity(nodePath, state) {
      var _a;
      if ((0, types_22.isWorkletizableFunctionPath)(nodePath)) {
      ...
      } else if ((0, types_22.isWorkletizableObjectPath)(nodePath)) {
