...
- Remove implicit worklet context objects from the Babel plugin. Object literals whose methods use `this` are no longer workletized during file workletization. ([#10411](https://github.com/software-mansion/react-native-reanimated/pull/10411) by [@tjzel](https://github.com/tjzel))
