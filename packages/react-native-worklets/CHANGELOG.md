...
- Accept Groovy `GString` values for `ndkVersion` and `ndkPath` from the root Gradle project instead of ignoring them. ([#10544](https://github.com/software-mansion/react-native-reanimated/pull/10544) by [@piaskowyk](https://github.com/piaskowyk))
