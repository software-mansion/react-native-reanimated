...
- Upgrade React Native to `0.88.0-rc.1` and React to `19.3.0`. The peer range widens to `0.83 - 0.88`. ([#10582](https://github.com/software-mansion/react-native-reanimated/pull/10582) by [@pawicao](https://github.com/pawicao))
