...
- Ship the OXC Worklets plugin as `react-native-worklets/plugin-oxc/babel`, with prebuilt binaries for macOS, Linux and Windows on x64 and arm64. ([#PR_NUMBER](https://github.com/software-mansion/react-native-reanimated/pull/PR_NUMBER) by [@tshmieldev](https://github.com/tshmieldev))
