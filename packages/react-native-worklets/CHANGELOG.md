...
- Preserve UI job order when a UI caller schedules work. ([#10638](https://github.com/software-mansion/react-native-reanimated/issues/10638) by [@janicduplessis](https://github.com/janicduplessis))
