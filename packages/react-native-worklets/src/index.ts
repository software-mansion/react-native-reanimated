...
export { reportFatalErrorOnJS, registerWorkletStackDetails } from './errors';
export {
  initializeUIRuntime,
  setupCallGuard,
  setupConsole,
} from './initializers';
export { getShadowNodeWrapperFromRef } from './fabricUtils';
...
export { PropsAllowlists } from './propsAllowlists';
export { makeShareableCloneRecursive, makeShareable } from './shareables';
export {
  runOnJS,
  runOnUI,
  executeOnUIRuntimeSync,
...
export { NativeReanimatedModule } from './NativeReanimated';
export { _updatePropsJS } from './js-reanimated';
