...
static jsi::Value WORKLETS_SPEC_PREFIX(makeSynchronizable)(
    jsi::Runtime &rt,
    TurboModule &turboModule,
    const jsi::Value *args,
    size_t) {
...
WorkletsModuleProxySpec::WorkletsModuleProxySpec(
  ...
  methodMap_["makeSynchronizable"] = MethodMetadata{
      .argCount = 1, .invoker = WORKLETS_SPEC_PREFIX(makeSynchronizable)};
