...
An array of timing functions. The order in this array corresponds to the array of style properties passed to the [`animationName`](/docs/next/next/css-animations/animation-name).
