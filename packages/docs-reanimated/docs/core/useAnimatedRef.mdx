...
`useAnimatedRef` lets you get a reference of a view. Used alongside [`measure`](/docs/next/advanced/measure), [`scrollTo`](/docs/next/scroll/scrollTo), and [`useScrollOffset`](/docs/next/scroll/useScrollOffset) functions.
