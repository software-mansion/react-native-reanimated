...
`withSequence` is an [animation modifier](/docs/next/fundamentals/glossary#animation-modifier) that lets you run animations in a sequence.
...
Any number of [animation objects](/docs/next/fundamentals/glossary#animation-object) to be run in a sequence.
