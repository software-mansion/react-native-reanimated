...
- The logger configuration is global and affects all warnings and errors shown by Reanimated. There's no option to configure the logger per file/component.
