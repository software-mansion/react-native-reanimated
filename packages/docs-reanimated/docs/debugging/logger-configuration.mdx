...
Reanimated shows warnings that indicate misuses of the library API, such as modifying the [shared value](/docs/next/fundamentals/glossary#shared-value) during component re-render. These logs can be configured to be more or less verbose.
