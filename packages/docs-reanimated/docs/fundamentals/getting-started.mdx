...
`react-native-worklets` is currently a required dependency. It was separated from `react-native-reanimated` for better modularity and will become optional in the future, only being required when worklet-based animations are used.
...
<Tabs groupId="package-managers">
  ...
  <TabItem value="yarn" label="YARN">
    ...
    yarn add react-native-reanimated@next react-native-worklets
