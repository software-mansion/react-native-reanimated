...
You can learn the details by reading the [Reanimated Babel plugin README](https://github.com/software-mansion/react-native-reanimated/blob/3.19-stable/packages/react-native-reanimated/plugin/README-dev.md).
