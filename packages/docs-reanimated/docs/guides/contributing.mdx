...
- `src/examples` - contains examples that are later presented in the documentation
- `src/components` - contains components used to make the pages interactive
- `static/recordings` - contains video recordings of the examples
- `static/img` - contains images used in the docs
