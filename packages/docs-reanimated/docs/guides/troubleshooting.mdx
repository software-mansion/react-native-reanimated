...
**Problem:** This happens when JavaScript side of Reanimated fails to get Worklets Babel plugin version.

**Solution:**

1. Part of your code might be transpiled with an outdated version of Worklets Babel plugin. See [Mismatch between JavaScript code version and Worklets Babel plugin version](#mismatch-between-javascript-code-version-and-reanimated-babel-plugin-version).
...
See [Couldn't determine the version of the native part of Reanimated](#couldnt-determine-the-version-of-the-native-part-of-reanimated) and [Unknown version of Worklets Babel plugin](#unknown-version-of-reanimated-babel-plugin).

### Mismatch between C++ code version and JavaScript code version

See (Mismatch between JavaScript part and native part of Reanimated)[#mismatch-between-javascript-part-and-native-part-of-reanimated] and (Mismatch between JavaScript code version and Worklets Babel plugin version)[#mismatch-between-javascript-code-version-and-reanimated-babel-plugin-version].
