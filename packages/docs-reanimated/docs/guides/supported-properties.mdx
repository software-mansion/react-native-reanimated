...
On the Web, to animate `textShadow` props (`textShadowColor`, `textShadowOffset`, `textShadowRadius`) using CSS Animations you need to specify them in every keyframe of the animation. Consider this example:
