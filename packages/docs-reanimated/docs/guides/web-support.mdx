...
Add `@babel/plugin-proposal-export-namespace-from` and Worklets Babel plugin to your `babel.config.js`.
...
Reanimated hooks all accept optional dependency arrays. Under the hood, the Worklets Babel plugin inserts these for you.
