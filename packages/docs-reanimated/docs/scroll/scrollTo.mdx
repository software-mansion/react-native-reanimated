...
An [animated ref](/docs/core/useAnimatedRef#returns) connected to the ScrollView or FlatList component you'd want to scroll on. The animated ref has to be passed either to an [Animated component](/docs/fundamentals/glossary#animated-component) or a React Native built-in component.
...
- The usage with the `Animated.FlatList` component is the same as with the `Animated.ScrollView` component.
