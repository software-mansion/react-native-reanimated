...
Reanimated comes with a bunch of predefined animations you can customize. For more advanced use-cases, you can use [Keyframes](/docs/next/layout-animations/keyframe-animations) or create your own [custom entering/exiting animations](/docs/next/layout-animations/custom-animations).
...
Time-based modifiers relay on [`withTiming`](/docs/next/animations/withTiming) function.
