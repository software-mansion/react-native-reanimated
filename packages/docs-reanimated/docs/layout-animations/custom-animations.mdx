...
<ExampleVideo
  sources={{
    android:
      '/react-native-reanimated/recordings/custom_animations/android_custom_exiting.mov',
    ios: '/react-native-reanimated/recordings/custom_animations/ios_custom_exiting.mov',
  }}
/>
...
<ExampleVideo
  sources={{
    android:
      '/react-native-reanimated/recordings/custom_animations/android_custom_entering.mov',
    ios: '/react-native-reanimated/recordings/custom_animations/ios_custom_entering.mov',
  }}
/>
