...
Curved transition enables to animate each position and dimension with different easing. It makes component movement path look curved.
...
Entry/Exit transition lets you choose layout animations for entering and exiting. It combines both of them into a single one and applies to the layout. Moreover, instead of picking currently available animations, you are welcome to create your own one.
