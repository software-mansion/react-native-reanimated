...
| ----------- | ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| sensor      | `SharedValue<Value3D｜ValueRotation>` | A [shared value](/docs/next/fundamentals/glossary#shared-value) containing the sensor measurements. The values returned by the sensor depend on the type of sensor you choose with [sensor(/docs/next/docs/next/device/useAnimatedSensor#sensortype) argument. |
...
- You can read the sensor data on both [UI thread](/docs/next/fundamentals/glossary#ui-thread) and [JavaScript th(/docs/next/docs/next/fundamentals/glossary#javascript-thread).
