...
import { useReanimated3SpringPlayground } from '@site/src/components/InteractivePlayground';

<InteractivePlayground usePlayground={useReanimated3SpringPlayground} />
