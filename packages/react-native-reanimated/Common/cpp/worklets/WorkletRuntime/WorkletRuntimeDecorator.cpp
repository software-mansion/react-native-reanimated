...
static inline std::vector<jsi::Value> parseArgs(jsi::Runtime &rt, std::shared_ptr<ShareableArray> shareableArgs) {
...
void WorkletRuntimeDecorator::decorate(
  ...
  jsi_utils::installJsiFunction(
      rt, "_makeShareableClone", [](jsi::Runtime &rt, const jsi::Value &value, const jsi::Value &nativeStateSource) {
        auto shouldRetainRemote = jsi::Value::undefined();
        return makeShareableClone(rt, value, shouldRetainRemote, nativeStateSource);
      });
