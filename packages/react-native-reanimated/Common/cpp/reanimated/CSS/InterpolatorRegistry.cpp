...
const InterpolatorFactoriesRecord FLEX_INTERPOLATORS = {
    ...
    {"margin", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addMarginToPropsBuilder))},
    {"marginBottom", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addMarginBottomToPropsBuilder))},
    {"marginEnd", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addMarginEndToPropsBuilder))},
    {"marginHorizontal",
     value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addMarginHorizontalToPropsBuilder))},
    {"marginLeft", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addMarginLeftToPropsBuilder))},
    {"marginRight", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addMarginRightToPropsBuilder))},
    {"marginStart", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addMarginStartToPropsBuilder))},
    {"marginTop", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addMarginTopToPropsBuilder))},
    {"marginVertical", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addMarginVerticalToPropsBuilder))},
    {"maxHeight",
    ...
    {"padding", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addPaddingToPropsBuilder))},
    {"paddingBottom", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addPaddingBottomToPropsBuilder))},
    {"paddingEnd", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addPaddingEndToPropsBuilder))},
    {"paddingHorizontal",
     value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addPaddingHorizontalToPropsBuilder))},
    {"paddingLeft", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addPaddingLeftToPropsBuilder))},
    {"paddingRight", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addPaddingRightToPropsBuilder))},
    {"paddingStart", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addPaddingStartToPropsBuilder))},
    {"paddingTop", value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addPaddingTopToPropsBuilder))},
    {"paddingVertical",
     value<CSSLength, CSSKeyword>(0, {RelativeTo::Parent, "width"}, CSSLengthKeywordCallback(addPaddingVerticalToPropsBuilder))},
