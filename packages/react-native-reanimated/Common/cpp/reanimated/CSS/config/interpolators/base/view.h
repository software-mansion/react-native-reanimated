...
const InterpolatorFactoriesRecord VIEW_INTERPOLATORS = {
    /**
    ...
    // top-left
    {"borderTopLeftRadius", value<CSSDimension>(RelativeTo::Self, "width", 0)},
    {"borderTopStartRadius", value<CSSDimension>(RelativeTo::Self, "width", 0)},
    {"borderStartStartRadius",
     value<CSSDimension>(RelativeTo::Self, "width", 0)},
    // top-right
    {"borderTopRightRadius", value<CSSDimension>(RelativeTo::Self, "width", 0)},
    {"borderTopEndRadius", value<CSSDimension>(RelativeTo::Self, "width", 0)},
    {"borderStartEndRadius", value<CSSDimension>(RelativeTo::Self, "width", 0)},
    // bottom-left
    {"borderBottomLeftRadius",
     value<CSSDimension>(RelativeTo::Self, "width", 0)},
    {"borderBottomStartRadius",
     value<CSSDimension>(RelativeTo::Self, "width", 0)},
    {"borderEndStartRadius", value<CSSDimension>(RelativeTo::Self, "width", 0)},
    // bottom-right
