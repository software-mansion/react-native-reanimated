...
#else
      movedViews[mutation.newChildShadowView.tag] = mutation.parentShadowView.tag;
#endif // REACT_NATIVE_MINOR_VERSION >= 78
    }
  }
...
#if REACT_NATIVE_MINOR_VERSION >= 78
  layoutAnimations_.insert_or_assign(tag, LayoutAnimation{finalView, currentView, mutation.parentTag, {}, count});
#else
...
#else
      strongThis->layoutAnimations_.insert_or_assign(tag, LayoutAnimation{finalView, current, parent, opacity});
#endif // REACT_NATIVE_MINOR_VERSION >= 78
