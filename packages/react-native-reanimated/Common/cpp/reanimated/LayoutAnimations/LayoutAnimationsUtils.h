...
struct StyleSnapshot {
  ...
  double opacity, shadowOffsetHeight, shadowOffsetWidth, shadowOpacity, shadowRadius;
    int borderRadius, borderTopLeftRadius, borderTopRightRadius, borderBottomLeftRadius, borderBottomRightRadius;
    ...
    StyleSnapshot(const ShadowView &shadowView, Rect window) {
        ...
        borderRadius = borderTopLeftRadius = borderTopRightRadius = borderBottomLeftRadius =  borderBottomRightRadius = 0;
