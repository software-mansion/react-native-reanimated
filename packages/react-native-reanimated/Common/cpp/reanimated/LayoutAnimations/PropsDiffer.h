...
struct TransformOperationWithDefault {
  ...
  TransformOperationWithDefault(
    jsi::Object& current,
    jsi::Object& defaultVal
...
class PropsDiffer {
  ...
  static std::vector<TransformOperationWithDefault> getTransformOperationsFromProps(jsi::Runtime& rt, const ViewProps& props);
  static void maybeAddOperationToDiff(jsi::Runtime& rt, const char* name, float value, float defaultValue, std::vector<TransformOperationWithDefault>& jsiOperations);

  void diffTransformOrigin(jsi::Runtime& rt);
  static void addTransformOriginToDiff(jsi::Runtime& rt, const TransformOrigin& transformOrigin, jsi::Object& jsiValues, const ShadowView& view);
