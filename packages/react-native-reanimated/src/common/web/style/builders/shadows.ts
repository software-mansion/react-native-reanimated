...
import type { RuleBuilder, ValueProcessor } from '../types';
...
export const boxShadowBuilder: RuleBuilder<BoxShadowProps> =
  createWebRuleBuilder<BoxShadowProps>(
    {
    ...
    ({
      ...
      if (!processedColor) {
        logger.warn(
          `Cannot apply shadowOpacity to shadowColor: ${shadowColor}`
        );
      }
...
export const textShadowBuilder: RuleBuilder<TextShadowProps> =
  createWebRuleBuilder<TextShadowProps>(
    {
