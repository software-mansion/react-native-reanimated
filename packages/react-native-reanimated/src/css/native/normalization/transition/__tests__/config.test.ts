...
describe(normalizeCSSTransitionProperties, () => {
  ...
  describe('pseudo-keyed transition fields', () => {
    test('collapses pseudo-keyed duration down to its default branch', () => {
      const config: CSSTransitionProperties = {
        transitionProperty: 'opacity',
    ...
    test('collapses every pseudo-keyed timing field down to its default branch', () => {
      const config: CSSTransitionProperties = {
        transitionProperty: 'opacity',
        transitionDuration: { default: '200ms', ':active': '50ms' },
    ...
    test('returns null when pseudo-keyed default leaves effective duration at 0', () => {
      const config: CSSTransitionProperties = {
        transitionProperty: 'opacity',
