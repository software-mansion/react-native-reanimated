...
describe(processSVGPath, () => {
  ...
  describe('C and S commands (Cubic)', () => {
    test.each([
      ...
      [
        ...
        'M 0 0 C 10 10 20 20 30 30 Z C 0 0 40 40 50 50',
      ],
      [
        'M 0 0 L 10 10 S 20 20 30 30',
        'M 0 0 C 3.3333333333333335 3.3333333333333335 6.666666666666667 6.666666666666667 10 10 C 10 10 20 20 30 30',
      ],
      [
      ...
      [
        ...
        'M 0 0 C 6.666666666666666 6.666666666666666 13.333333333333334 13.333333333333334 20 20 C 20 20 30 30 40 40',
      ],
    ])('for %p returns %p', (input, expected) => {
      expect(processSVGPath(input)).toEqual(expected);
    });
  ...
  describe('Q and T commands', () => {
    test.each([
      ...
      [
        ...
        'M 0 0 C 10 10 20 20 30 30 C 30 30 33.333333333333336 33.333333333333336 40 40',
      ],
    ])('for %p returns %p', (input, expected) => {
      expect(processSVGPath(input)).toEqual(expected);
    });
  ...
  describe('A (Arc) command', () => {
    test.each([
      ...
      ['M 10 10 A 5 5 0 0 1 10 10', 'M 10 10'],
      [
