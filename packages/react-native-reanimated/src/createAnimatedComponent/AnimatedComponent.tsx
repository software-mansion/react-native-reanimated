  ...
  implements IAnimatedComponentInternal
{
  ...
  _updateStyles(props: AnimatedComponentProps<InitialComponentProps>): void {
    ...
    if (filteredAnimatedProps.cssStyle) {
      if (filteredStyles.cssStyle) {
        logger.warn(
          'AnimatedComponent: CSS properties cannot be used in style and animatedProps at the same time. Using properties the style object.'
        );
