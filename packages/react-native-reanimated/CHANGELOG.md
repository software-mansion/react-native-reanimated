...
- Fix `linear()` easing producing output progress outside its declared values when the first or the last control point carries an explicit input progress that breaks monotonicity. ([#10380](https://github.com/software-mansion/react-native-reanimated/pull/10380) by [@dennytosp](https://github.com/dennytosp))
