...
- Deliver CSS animation and transition cancellation callbacks on web when their element unmounts, without pending cleanup retaining otherwise unreachable elements on browsers with weak reference support. ([#10520](https://github.com/software-mansion/react-native-reanimated/pull/10520) by [@MatiPl01](https://github.com/MatiPl01))
- Preserve active CSS animation rules when a web manager is reused before deferred unmount cleanup. ([#10520](https://github.com/software-mansion/react-native-reanimated/pull/10520) by [@MatiPl01](https://github.com/MatiPl01))
