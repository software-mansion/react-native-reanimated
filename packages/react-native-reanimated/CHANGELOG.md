...
- Keep native CSS transition timing and resume values correct for delayed zero-duration transitions and color or size properties migrating back to the C++ loop. ([#10529](https://github.com/software-mansion/react-native-reanimated/pull/10529) by [@MatiPl01](https://github.com/MatiPl01))
