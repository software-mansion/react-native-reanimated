...
- Fix views with an exiting animation staying mounted, and still absorbing touches, when several layout animations overlap on the same tag: the removal intent is now latched until the tag settles instead of being dropped by whichever animation finishes last. ([#10376](https://github.com/software-mansion/react-native-reanimated/pull/10376) by [@dennytosp](https://github.com/dennytosp))
