...
- Keep native CSS transition timing and resume values correct for delayed zero-duration transitions and color or size properties migrating back to the C++ loop. ([#10356](https://github.com/software-mansion/react-native-reanimated/pull/10356) by [@MatiPl01](https://github.com/MatiPl01))
