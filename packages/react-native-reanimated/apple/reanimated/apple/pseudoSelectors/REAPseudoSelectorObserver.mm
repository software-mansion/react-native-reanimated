...
- (void)attachSelector:(NSString *)selectorName toView:(REAUIView *)view
{
  ...
  if ([selectorName isEqualToString:@":active"]) {
    ...
    for (NSNotificationName beginName in @[UITextFieldTextDidBeginEditingNotification,
    ...
    for (NSNotificationName endName in @[UITextFieldTextDidEndEditingNotification,
