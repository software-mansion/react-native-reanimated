...
export declare function registerCSSKeyframes(animationName: string, keyframesConfig: NormalizedCSSAnimationKeyframesConfig): void;
export declare function unregisterCSSKeyframes(animationName: string): void;
