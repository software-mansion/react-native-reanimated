...
NativeProxy::NativeProxy(
    ...
    : javaPart_(jni::make_global(jThis)),
      ...
      commonReanimatedModule_(std::make_shared<CommonReanimatedModule>(
          *rnRuntime,
...
void NativeProxy::commonInit(
  ...
  commonReanimatedModule_->initializeFabric(uiManager);
  ...
  //       return commonReanimatedModule->handleRawEvent(
...
NativeProxy::~NativeProxy() {
  ...
  // destructor is ran
  commonReanimatedModule_->cleanupSensors();
}
...
void NativeProxy::installJSIBindings() {
  ...
  RNRuntimeDecorator::decorate(
      rnRuntime, commonReanimatedModule_, isReducedMotion);
#ifndef NDEBUG
...
bool NativeProxy::isAnyHandlerWaitingForEvent(
  ...
  return commonReanimatedModule_->isAnyHandlerWaitingForEvent(
      eventName, emitterReactTag);
}

void NativeProxy::performOperations() {
#ifdef RCT_NEW_ARCH_ENABLED
  commonReanimatedModule_->performOperations();
#endif
}
...
void NativeProxy::handleEvent(
  ...
  jsi::Runtime &rt = commonReanimatedModule_->getUIRuntime();
  jsi::Value payload;
  try {
  ...
  commonReanimatedModule_->handleEvent(
...
void NativeProxy::setupLayoutAnimations() {
  auto weakCommonReanimatedModule =
      std::weak_ptr<CommonReanimatedModule>(commonReanimatedModule_);

  layoutAnimations_->cthis()->setAnimationStartingBlock(
      [weakCommonReanimatedModule](
        ...
        if (auto commonReanimatedModule = weakCommonReanimatedModule.lock()) {
          ...
          commonReanimatedModule->layoutAnimationsManager()
  ...
  layoutAnimations_->cthis()->setHasAnimationBlock(
      [weakCommonReanimatedModule](int tag, int type) {
        if (auto commonReanimatedModule = weakCommonReanimatedModule.lock()) {
          return commonReanimatedModule->layoutAnimationsManager()
  ...
  layoutAnimations_->cthis()->setShouldAnimateExitingBlock(
      [weakCommonReanimatedModule](int tag, bool shouldAnimate) {
        if (auto commonReanimatedModule = weakCommonReanimatedModule.lock()) {
          return commonReanimatedModule->layoutAnimationsManager()
  ...
  layoutAnimations_->cthis()->setCheckDuplicateSharedTag(
      [weakCommonReanimatedModule](int viewTag, int screenTag) {
        if (auto commonReanimatedModule = weakCommonReanimatedModule.lock()) {
          commonReanimatedModule->layoutAnimationsManager()
  ...
  layoutAnimations_->cthis()->setClearAnimationConfigBlock(
      [weakCommonReanimatedModule](int tag) {
        if (auto commonReanimatedModule = weakCommonReanimatedModule.lock()) {
          commonReanimatedModule->layoutAnimationsManager()
  ...
  layoutAnimations_->cthis()->setGetSharedGroupBlock(
      [weakCommonReanimatedModule](int tag) -> std::vector<int> {
        if (auto commonReanimatedModule = weakCommonReanimatedModule.lock()) {
          return commonReanimatedModule->layoutAnimationsManager()
              .getSharedGroup(tag);
        } else {
