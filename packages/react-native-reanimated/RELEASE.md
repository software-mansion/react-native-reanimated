...
8. Select your workflow from the list and download artifacts. <img width="925" alt="upload_b4eaebea327e62c1c99d44b1984066b3" src="https://github.com/user-attachments/assets/cfd54b99-2cff-4f60-b818-f92a53e62c07" />

8. Unzip your artifacts:
...
8. Test the package in a clean React Native app:
...
8. If everything works fine you can merge the PR.

8. Upload the package to npm:
...
8. After publishing briefly test if it works, when downloaded from npm:
...
8. Ask Kacper Kapuściak for a tweet informing the world about new Reanimated (patches don't count).
