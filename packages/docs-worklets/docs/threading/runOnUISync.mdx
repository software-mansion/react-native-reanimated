...
A function you want to execute on the [UI Runtime](/docs/fundamentals/glossary#ui-runtime).
...
`runOnUISync` returns the return value of the function passed as the first argument. It can only return values that can be converted to a [Serializable](/docs/fundamentals/glossary#serializable).
