...
function shortOffenderFactory() {
  return function shortOffender() {
    'worklet';
    let I = 'am';
    let a = 'very';
...
function longOffenderFactory() {
  return function longOffender() {
    'worklet';
    let a =
...
export default function BabelVersionCheckExample() {
  const forceErrorWithShortWorklet = () => {
    const shortOffender = shortOffenderFactory();
  ...
  const forceErrorWithLongWorklet = () => {
    const longOffender = longOffenderFactory();
    // @ts-ignore this is fine
