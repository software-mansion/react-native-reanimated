...
`runOnUI` lets you asynchronously run [workletized](/docs/worklets-plugin/about#autoworkletization) functions on the [UI thread](/docs/tutorials/concurrency-model#the-react-native-model).
