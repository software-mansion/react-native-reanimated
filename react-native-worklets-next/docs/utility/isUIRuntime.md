...
Checks if the current runtime is the [UI Runtime](/docs/concepts/runtimeKinds#ui-runtime).
...
`true` if the current runtime is the [UI Runtime](/docs/concepts/runtimeKinds#ui-runtime), `false` otherwise.
