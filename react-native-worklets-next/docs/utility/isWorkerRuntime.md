...
Checks if the current runtime is a [Worker Runtime](/docs/concepts/runtimeKinds#worker-runtime).
...
`true` if the current runtime is the [Worker Runtime](/docs/concepts/runtimeKinds#worker-runtime), `false` otherwise.
