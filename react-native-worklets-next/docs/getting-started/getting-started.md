...
To learn more, explore our tutorials section, starting with the explanation for the [purpose](/docs/tutorials/concurrency-model) of the library.
...
And that's it! The Worklets library is now configured in your Expo project.
...
In short, the Worklets babel plugin automatically converts special JavaScript functions (called [worklet functions](/docs/tutorials/concurrency-model#worklet-functions)) to allow them to be passed and run on the [Worklet Runtimes](/docs/concepts/runtimeKinds#worklet-runtime)
