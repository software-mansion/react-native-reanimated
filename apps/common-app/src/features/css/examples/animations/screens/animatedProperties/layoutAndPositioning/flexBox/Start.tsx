      ...
      sections={[
        {
          ...
          examples: [
            {
              description:
                'When layout direction is `ltr`, `start` is the left edge of the element and works as if the `left` property was set.',
              direction: 'ltr',
              title: 'Left to Right Layout',
            },
            {
              description:
                'When layout direction is `rtl`, `start` is the right edge of the element and works as if the `right` property was set.',
              direction: 'rtl',
