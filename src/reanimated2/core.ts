...
/** Function setImmediate is not in global runtime if the user doesn't use React Native. So if it's undefined we add it to runtime as a copy of requestAnimationFrame.
 */
