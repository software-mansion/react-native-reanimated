...
export function makeUICustomSetterMutable<T>(
  initial: T,
  customSetter: (sv: any, value: any) => void,
...
export function makeCustomSetterMutable<T>(
  initial: T,
  ...
  const handle = makeShareableCloneRecursive({
    __init: () => {
      'worklet';
      return makeUICustomSetterMutable(initial, customSetter, syncDataHolder);
    },
  });
