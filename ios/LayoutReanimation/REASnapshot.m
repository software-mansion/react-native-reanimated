...
- (instancetype)init:(UIView *)view withConverter:(UIView *)converter withParent:(UIView *)parent
{
  ...
  //  _values[@"globalOriginX"] = [NSNumber numberWithDouble:originFromRootPerspective123.x - view.bounds.size.width
  //  / 2.0]; _values[@"globalOriginY"] = [NSNumber numberWithDouble:originFromRootPerspective123.y -
