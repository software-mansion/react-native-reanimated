...
- The `animatedRef` argument can be changed at will and the hook will correctly return values basing on the ScrollView component it is connected to, for example:
