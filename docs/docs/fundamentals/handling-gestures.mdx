...
You can make the use of [composing gestures](https://docs.swmansion.com/react-native-gesture-handler/docs/fundamentals/gesture-composition/) to more complex behaviors. But what if we'd like to create something a bit more interesting?
