...
For **android devices**, be sure to wrap your App entry point with *GestureHandlerRootView* component from *react-native-gesture-handler* library to wrap your entire app.
