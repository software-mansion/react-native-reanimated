...
#### Supported Rect Native versions for Reanimated 3

| Reanimated                  | New Architecture (fabric) enabled | Minimum React-native | Maximum React-native |
| --------------------------- | --------------------------------- | -------------------- | -------------------- |
| from **3.1.x** to **3.5.x** | ✅                                | 0.72                 | 0.72                 |
| from **3.4.x** to **3.5.x** | ❌                                | 0.66                 | 0.72                 |
| from **3.1.x** to **3.3.x** | ❌                                | 0.63                 | 0.72                 |

#### Supported Rect Native versions for Reanimated 2

| Reanimated                  | Minimum React-native | Maximum React-native |
| --------------------------- | -------------------- | -------------------- |
| above **2.10.x**            | 0.63                 | 0.70                 |
