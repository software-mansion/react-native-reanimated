...
**Problem:**
This issue happens when Reanimated fails to initialize its native side from JavaScript.
...
2. Check if your platform is supported by Reanimated. Currently we support:
   ...
   - iOS
   - Web
3. If you are running in a brownfield app, make sure to initialize the native library manually.
...
**Solution:** Please upgrade to at React Native 0.72 or downgrade to an older version of Reanimated 3.
