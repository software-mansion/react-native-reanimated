...
**Solution:** Please upgrade to at newer version of React Native or downgrade to an older version of Reanimated 3.
See [this link](Compatibility) for full list of supported versions of React Native.
