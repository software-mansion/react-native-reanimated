...
import Fade from '@site/src/examples/LayoutAnimations/Fade';
import FadeSrc from '!!raw-loader!@site/src/examples/LayoutAnimations/Fade';

<InteractiveExample src={FadeSrc} component={<Fade />} />
