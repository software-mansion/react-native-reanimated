...
- If you need to inspect animations frame by frame, record the screen and open the recording in QuickTime Player, where you can step through individual frames with the left and right arrow keys.
