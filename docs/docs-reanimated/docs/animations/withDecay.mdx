...
<InteractiveExample src={DecayBasicSrc} component={DecayBasic} label="Grab and drag the square"/>
...
<InteractiveExample src={DecayTrainSrc} component={DecayTrain} label="Grab and drag the train"/>
