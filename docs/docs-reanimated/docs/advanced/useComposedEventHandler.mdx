...
import ComposedEventHandler from '@site/src/examples/ComposedEventHandler';
import ComposedEventHandlerSrc from '!!raw-loader!@site/src/examples/ComposedEventHandler';

<InteractiveExample src={ComposedEventHandlerSrc} component={ComposedEventHandler}/>
