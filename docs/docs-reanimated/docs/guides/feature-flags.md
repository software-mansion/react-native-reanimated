...
| [`VERBOSE_MODE`](#verbose_mode)                                                                     | [static](#static-feature-flags) |  4.2.0   |  &ndash;   |    `false`    |
...
When enabled, detailed output for diagnostic purposes will be logged to the console (Logcat for Android, Xcode Debug Console for iOS).
