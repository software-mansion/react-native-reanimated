...
<InteractiveExample src={InterpolateRotationSrc} component={InterpolateRotation} label="Grab and drag any of the squares. The dashed lines indicate the range of the interpolation."/>
