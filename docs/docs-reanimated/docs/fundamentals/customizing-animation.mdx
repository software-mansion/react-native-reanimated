...
import { useTimingPlayground, useSpringPlayground } from '@site/src/components/InteractivePlayground';

<InteractiveExample src={TimingEasingCompareSrc} component={TimingEasingCompare}/>
