...
Shared Element Transitions is an experimental feature available <a href="/react-native-reanimated/docs/guides/feature-flags#enable_shared_element_transitions">behind a feature flag</a>, not recommended for production use yet. We are waiting for your feedback to improve the implementation.
