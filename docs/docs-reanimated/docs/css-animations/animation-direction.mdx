...
<InteractiveExample src={AnimationDirectionBasicSrc} component={AnimationDirectionBasic}/>
...
<InteractiveExample src={AnimationDirectionSrc} component={AnimationDirection}/>
