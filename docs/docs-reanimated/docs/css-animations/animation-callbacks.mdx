...
Fires when the animation is removed before finishing - for example, when the animation name changes or the style drops it. On Android and iOS, it also fires when the component unmounts. On web, unmounting the component doesn't fire this callback.
