...
<InteractiveExample src={AnimationIterationCountBasicSrc} component={AnimationIterationCountBasic}/>
...
<InteractiveExample src={AnimationIterationCountSrc} component={AnimationIterationCount} label="Square wobbles 3 times"/>
