...
<InteractiveExample src={TransitionTimingFunctionBasicSrc} component={TransitionTimingFunctionBasic}/>
...
<InteractiveExample src={TransitionTimingFunctionStepsSrc} component={TransitionTimingFunctionSteps}/>
