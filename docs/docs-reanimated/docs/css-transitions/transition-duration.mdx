...
<InteractiveExample src={TransitionDurationBasicSrc} component={TransitionDurationBasic}/>
...
<InteractiveExample src={TransitionDurationSrc} component={TransitionDuration}/>
