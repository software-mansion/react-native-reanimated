...
<InteractiveExample src={TransitionBehaviorBasicSrc} component={TransitionBehaviorBasic}/>
...
<InteractiveExample src={TransitionBehaviorSrc} component={TransitionBehavior} label="Comparison between allow-discrete and normal"/>
