...
* [**Chrome debugger**](https://reactnative.dev/docs/debugging#chrome-developer-tools)
  (also known as the *React Native Debugger*) is a simple tool that creates a web
...
* [**Flipper**](https://fbflipper.com/) (Hermes debugger) is an app created by
  Facebook that makes it easy to use the *Chrome DevTools* while providing additional tools for
...
* `0.76.7` → [here](/content/metro-inspector-proxy+0.76.7.patch)
* `0.76.5` → [here](/content/metro-inspector-proxy+0.76.5.patch)
* `0.76.4` → [here](/content/metro-inspector-proxy+0.76.4.patch)
* `0.76.0` → [here](/content/metro-inspector-proxy+0.76.0.patch)
* `0.73.7` → [here](/content/metro-inspector-proxy+0.73.7.patch)
* `0.73.5` → [here](/content/metro-inspector-proxy+0.73.5.patch)
* `0.72.3` → [here](/content/metro-inspector-proxy+0.72.3.patch)
* `0.72.1` → [here](/content/metro-inspector-proxy+0.72.1.patch)
...
*Debugging relies on source maps that are generated by the Worklets Babel plugin, so you
