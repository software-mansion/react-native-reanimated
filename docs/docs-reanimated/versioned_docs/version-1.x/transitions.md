...
This API is still experimental and is a subject to change. Please refer to our [Example app](https://github.com/software-mansion/react-native-reanimated/tree/1.13.4/Example/src/transitions) to see how it can be used in practice in the current shape.
