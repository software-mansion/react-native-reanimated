...
- [`SVGAdapter`](https://github.com/software-mansion/react-native-reanimated/blob/2.17.0/src/reanimated2/PropAdapters.ts#L19) for handling `transform` property in `react-native-svg`
- [`TextInputAdapter`](https://github.com/software-mansion/react-native-reanimated/blob/2.17.0/src/reanimated2/PropAdapters.ts#L57).
