...
`useAnimatedGestureHandler` lets you create animations based on [gesture handlers](https://docs.swmansion.com/react-native-gesture-handler/docs/2.x/category/gesture-handlers-legacy).
