...
You can make use of [composing gestures](https://docs.swmansion.com/react-native-gesture-handler/docs/2.x/fundamentals/gesture-composition/) to more complex behaviors. But what if we'd like to create something a bit more interesting?
...
<InteractiveExample src={PanGestureSrc} component={PanGesture} label="Grab and drag the circle"/>
...
<InteractiveExample src={DecayBasicSrc} component={DecayBasic} label="Grab and release the square"/>
