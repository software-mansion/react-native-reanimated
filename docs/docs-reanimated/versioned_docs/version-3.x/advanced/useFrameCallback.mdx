...
<InteractiveExample src={FrameCallbackSimpleSrc} component={FrameCallbackSimple}/>
...
<InteractiveExample src={FrameCallbackDinoSrc} component={FrameCallbackDino} label="Tap to jump"/>
