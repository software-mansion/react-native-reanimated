...
`runOnUI` lets you asynchronously run [workletized](/docs/0.10-0.12/fundamentals/glossary#to-workletize) functions on the [UI thread](/docs/0.10-0.12/fundamentals/glossary#ui-thread).
...
<InteractiveExample src={RunOnUISrc} component={RunOnUI} label="Tap each word"/>
...
- The callback passed as the argument is automatically [workletized](/docs/0.10-0.12/fundamentals/glossary#to-workletize) and ready to be run on the [UI thread](/docs/0.10-0.12/fundamentals/glossary#ui-thread).
