...
`executeOnUIRuntimeSync` lets you run a [workletized](/docs/0.10-0.12/fundamentals/glossary#to-workletize) function synchronously on the [UI thread](/docs/0.10-0.12/fundamentals/glossary#ui-thread).
