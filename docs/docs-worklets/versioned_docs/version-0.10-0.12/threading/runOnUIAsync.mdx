...
`runOnUIAsync` lets you asynchronously run [workletized](/docs/0.10-0.12/fundamentals/glossary#to-workletize) functions on the [UI thread](/docs/0.10-0.12/fundamentals/glossary#ui-thread).
