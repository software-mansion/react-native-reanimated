...
**Solution:** See [installation docs](/docs/0.10-0.12/fundamentals/getting-started#installation) for more information.
...
1. Check if your platform is supported by Worklets. Currently we support:
   - Android
   - iOS
   - macOS
   - tvOS
   - visionOS
   - Web
1. If you are using Worklets in a brownfield app, make sure to initialize the native library manually.
...
Check [this page](/docs/0.10-0.12/fundamentals/glossary#worklet) to learn more about worklets.
