...
Checks if the current runtime is a [Worker Runtime](/docs/0.10-0.12/fundamentals/runtimeKinds#worker-runtime).
...
`true` if the current runtime is the [Worker Runtime](/docs/0.10-0.12/fundamentals/runtimeKinds#worker-runtime), `false` otherwise.
