...
support](/docs/0.10-0.12/worklets-babel-plugin/about#experimental-worklet-classes).
...
This option changes how global variables are handled inside worklets. You can read more about closures and global scoping [here](/docs/0.10-0.12/fundamentals/closures#global-scoping).
