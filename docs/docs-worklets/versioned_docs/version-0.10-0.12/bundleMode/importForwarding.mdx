...
[`importForwarding`](/docs/0.10-0.12/worklets-babel-plugin/plugin-options#importforwarding)
...
To learn more about closures, see [this section](/docs/0.10-0.12/fundamentals/closures)
