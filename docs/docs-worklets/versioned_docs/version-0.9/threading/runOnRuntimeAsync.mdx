...
`runOnRuntimeAsync` lets you asynchronously run [worklets](/docs/0.9/fundamentals/glossary#worklet) on a [Worker Runtime](/docs/0.9/fundamentals/runtimeKinds#worker-runtime).
...
A reference to a function you want to execute on the [Worker Runtime](/docs/0.9/fundamentals/runtimeKinds#worker-runtime). Arguments to your function have to be passed after the worklet i.e. `runOnRuntimeAsync(workletRuntime, setValue, 10);`.

### args

Arguments to the function you want to execute on the [Worker Runtime](/docs/0.9/fundamentals/runtimeKinds#worker-runtime).
...
- The callback passed as the argument is automatically [workletized](/docs/0.9/fundamentals/glossary#to-workletize) and ready to be run on the [Worker Runtime](/docs/0.9/fundamentals/runtimeKinds#worker-runtime).
