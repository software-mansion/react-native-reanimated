...
`executeOnUIRuntimeSync` lets you run a [workletized](/docs/0.9/fundamentals/glossary#to-workletize) function synchronously on the [UI thread](/docs/0.9/fundamentals/glossary#ui-thread).
