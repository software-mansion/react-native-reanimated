...
**Solution:** See [installation docs](/docs/0.9/fundamentals/getting-started#installation) for more information.
...
Check [this page](/docs/0.9/fundamentals/glossary#worklet) to learn more about worklets.
