...
- In [Legacy Eval Mode](/docs/bundleMode#legacy-eval-mode), `createSynchronizable` can be called only on the [RN Runtime](/docs/0.9/fundamentals/runtimeKinds#rn-runtime). In Bundle Mode, it can be called on any Runtime.
