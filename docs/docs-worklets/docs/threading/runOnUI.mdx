...
`runOnUI` lets you asynchronously run [workletized](/docs/worklets-babel-plugin/about#autoworkletization) functions on the [UI thread](/docs/tutorials/concurrency-model#the-react-native-model).
...
- The callback passed as the argument is automatically [workletized](/docs/worklets-babel-plugin/about#autoworkletization) and ready to be run on the [UI thread](/docs/tutorials/concurrency-model#the-react-native-model).
