...
`executeOnUIRuntimeSync` lets you run a [workletized](/docs/worklets-babel-plugin/about#autoworkletization) function synchronously on the [UI thread](/docs/tutorials/concurrency-model#the-react-native-model).
