...
1. Check if your platform is supported by the Worklets library. Currently we support:
   - Android
   - iOS
   - macOS
   - tvOS
   - visionOS
   - Web
1. If you are using the Worklets library in a brownfield app, make sure to initialize the native library manually.
