...
:::warning
[RNRepo](https://rnrepo.org/) does not support Worklets static feature flags. If you would like to modify static feature flags while using RNRepo in your project, you must force building Worklets from source by adding deny list configuration as described in [RNRepo's documentation](https://github.com/software-mansion/rnrepo/blob/main/TROUBLESHOOTING.md#deny-list-configuration).
:::
