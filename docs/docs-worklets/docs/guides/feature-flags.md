...
This feature flag enables [the Bundle Mode](https://docs.swmansion.com/react-native-worklets/docs/bundleMode/overview/). Make sure to follow the rest of the [setup instructions](https://docs.swmansion.com/react-native-worklets/docs/bundleMode/setup/) after enabling this flag.
