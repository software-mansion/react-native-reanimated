...
React Native Runtime - a JavaScript Runtime spawned by React Native. There's only one React Native in your app. It's the Runtime where React lives and your app's JavaScript code is executed. This Runtime is executed by the React Native's [JS Thread](https://reactnative.dev/architecture/threading-model). This is the only Runtime that has access to the React Native APIs and the app's state and components.
