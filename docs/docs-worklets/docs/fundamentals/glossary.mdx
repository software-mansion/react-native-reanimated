...
A worklet is a short-running JavaScript function that can be moved and executed across different [Worklet Runtimes](/docs/fundamentals/glossary#worklet-runtime) and the [React Native Runtime](/docs/fundamentals/glossary/#react-native-runtime-rn-runtime).
