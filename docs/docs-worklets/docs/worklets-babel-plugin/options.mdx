...
This option changes how global variables are handled inside worklets. You can read more about closures and global scoping [here](/docs/concepts/closures#global-scoping).
