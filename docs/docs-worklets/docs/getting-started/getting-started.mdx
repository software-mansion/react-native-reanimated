...
<Tabs groupId="development-framework" queryString>
  ...
  <TabItem value="rnc-cli" label="React Native Community CLI">
    ...
    <details>
      ...
      In short, the Worklets babel plugin automatically converts special JavaScript functions (called [worklets](/docs/tutorials/concurrency-model#worklet-functions)) to allow them to be passed and run on the [Worklet Runtimes](/docs/concepts/runtimeKinds#worklet-runtime)
