...
- Outside of [Bundle Mode](/docs/experimental/bundleMode), `createSynchronizable` can be called only on the [RN Runtime](/docs/fundamentals/glossary#rn-runtime). In Bundle Mode, it can be called from any runtime.
