...
`runOnUISync` lets you run a [workletized](/docs/worklets-plugin/about#autoworkletization) function synchronously on the [UI Runtime](/docs/concepts/runtimeKinds#ui-runtime).

To compare it with [`scheduleOnUI`](/docs/threading/scheduleOnUI) and [`runOnUIAsync`](/docs/threading/runOnUIAsync), see [Running worklet functions on the UI runtime](/docs/guides/running-on-the-ui-runtime).
...
A function you want to execute on the [UI Runtime](/docs/concepts/runtimeKinds#ui-runtime).
