...
To address this, Reanimated provides a Metro configuration wrapper called `wrapWithReanimatedMetroConfig`. This wrapper automatically adjusts your Metro config to improve the accuracy of call stacks in warnings and errors generated by the Reanimated library. On React Native Windows, it also selects the JavaScript implementations of Reanimated and Worklets.
...
* On React Native Windows, the wrapper enables the JavaScript fallback for Reanimated and Worklets. It does not provide native animations or a native Worklets runtime.
