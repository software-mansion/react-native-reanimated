...
private:
  ...
  class JSI_EXPORT NativeFantomForcedCloneCommitHookCxxSpecJSI : public TurboModule {
protected:
  NativeFantomForcedCloneCommitHookCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);
...
template <typename T>
class JSI_EXPORT NativeFantomForcedCloneCommitHookCxxSpec : public TurboModule {
public:
  jsi::Value create(jsi::Runtime &rt, const jsi::PropNameID &propName) override {
    return delegate_.create(rt, propName);
  }
  ...
  static constexpr std::string_view kModuleName = "NativeFantomForcedCloneCommitHookCxx";

protected:
  NativeFantomForcedCloneCommitHookCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule(std::string{NativeFantomForcedCloneCommitHookCxxSpec::kModuleName}, jsInvoker),
      delegate_(reinterpret_cast<T*>(this), jsInvoker) {}


private:
  class Delegate : public NativeFantomForcedCloneCommitHookCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeFantomForcedCloneCommitHookCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {
  ...
  private:
    friend class NativeFantomForcedCloneCommitHookCxxSpec;
    T *instance_;
  };
