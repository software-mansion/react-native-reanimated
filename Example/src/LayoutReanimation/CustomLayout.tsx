...
import Animated, { AnimatedLayout, makeMutable, withTiming, withDelay } from 'react-native-reanimated';
...
function CustomLayoutTransiton() {
  ...
  return (values) => { 
    ...
    return {
      animations: {
        originX: withDelay(isEvenLocal? 1000 : 0, withTiming(values.originX, {duration: 1000})),
        originY: withDelay(isEvenLocal? 0 : 1000, withTiming(values.originY, {duration: 1000})),
