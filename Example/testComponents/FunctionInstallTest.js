...
const WithWorkletTest = () => {
  ...
  useWorklet(
    function(obj, w) {
      'worklet';
      console.log(
        `[worklet] start ${obj.r.curr.value}/${obj.g.curr.value}/${obj.b.curr.value}`
      );
...
const FunctionInstallTest = () => {
  ...
  useWorklet(
    function(input) {
      ...
      if (
        JSON.stringify(obAKeys.sort()) ===
        JSON.stringify(['id', 'a', 'b', 'd'].sort())
      ) {
  ...
  /* */
  // test weird paths
  install('a.b.z.c.d.e.f.g.h.i.j.k.l.m.n.o.p.q.r.s.t.u.v.w.x.y.z', function(
    a,
    b
  ) {
    'worklet';
  ...
  useWorklet(function() {
    ...
    console.log(
      '[worklet] testing long paths, should execute function and be 21: ' +
        a.b.z.c.d.e.f.g.h.i.j.k.l.m.n.o.p.q.r.s.t.u.v.w.x.y.z(5, 4)
    );
    console.log(
      '[worklet] testing long paths, should be 661:' +
        qwe.rty.uio.p.asd.fgh.jkl.zxc.vbn.mmm
    );
    qwe.rty.uio.p.asd.fgh.jkl.zxc.vbn.mmm++;
    console.log(
      '[worklet] testing long paths, should be 662:' +
        qwe.rty.uio.p.asd.fgh.jkl.zxc.vbn.mmm
    );
    return true;
  })();
  ...
  useWorklet(function() {
    ...
    console.log(
      '[worklet] testing custom container should be 345: ' +
        my.custom.container.val
    );
    my.custom.container.val += 5;
    console.log(
      '[worklet] testing custom container should be 350: ' +
        my.custom.container.val
    );
    return true;
  })();
